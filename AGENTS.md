...
| **#9** | ✅ P1 已修 (TDD) | `LlmConfig.normalize*` 命中 keyword 改 throw `LlmError` | `common/src/main/ets/llm/LlmConfig.ets` ✅ + 5 个 Node 测试 (commits: `acb1a1c` RED, `1a53a82` GREEN) + spec: [`docs/specs/009-llm-config-throw-on-silent-override.md`](./docs/specs/009-llm-config-throw-on-silent-override.md) |
